...
register(id='SimpleVSS-v0',
         entry_point='rsoccer_gym.vss.env_vss:SimpleVSSEnv',
         max_episode_steps=1200
         )
...
register(id='SSL3v34DefendEnv-v0',
         entry_point='rsoccer_gym.ssl.my_envs:SSL3v34DefendEnv',
         max_episode_steps=1200
         )